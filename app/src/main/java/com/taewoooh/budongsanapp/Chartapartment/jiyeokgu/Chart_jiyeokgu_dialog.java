...
public class Chart_jiyeokgu_dialog extends Dialog implements View.OnClickListener {
    ...
    public Chart_jiyeokgu_dialog(@NonNull Context context, ChartDialogClickListener chartDialogClickListener) {
        super(context);
...
//        getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));  //다이얼로그의 배경을 투명으로 만듭니다.
    ...
    public Chart_jiyeokgu_dialog(@NonNull Context context) {
        super(context);
        this.context = context;
