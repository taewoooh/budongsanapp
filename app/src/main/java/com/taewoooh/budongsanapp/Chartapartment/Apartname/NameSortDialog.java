...
public class NameSortDialog extends Dialog implements View.OnClickListener {
    ...
    public NameSortDialog(@NonNull Context context, CustomDialogClickListener customDialogClickListener) {
        super(context);
    ...
    public NameSortDialog(@NonNull Context context) {
        super(context);
        this.context = context;
