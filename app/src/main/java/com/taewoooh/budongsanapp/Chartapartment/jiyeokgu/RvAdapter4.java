...
public class RvAdapter4 extends RecyclerView.Adapter<RvAdapter4.CustomViewHolder> {

    private ArrayList<ListViewItem4> items = null;
    private ArrayList<ListViewItem4> arrayList;
    ...
    public RvAdapter4(ArrayList<ListViewItem4> items, Context context) {
        this.context = context;
        this.items = items;
        arrayList = new ArrayList<ListViewItem4>();
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chart_jiyeokgu_list_item, parent, false);
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.jiyeokgu.setText(items.get(safePosition).getJiyeokgu()); //단지이름
        ...
        String b= items.get(safePosition).getJiyeokgu();
        ...
        try {
             ...
             if (bup.contains(searchString)) {
                ...
                Spannable spanString = Spannable.Factory.getInstance().newSpannable(holder.jiyeokgu.getText());
                spanString.setSpan(new BackgroundColorSpan(0xFFFFFF00), startPos, endPos, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                holder.jiyeokgu.setText(spanString);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(View itemView) {
            ...
            jiyeokgu = itemView.findViewById(R.id.jiyeokgu);
